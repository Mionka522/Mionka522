...
Мое обучение сосредотачивалось не только на теоретических аспектах, но и на практических применениях знаний. Я активно работала над проектами, включая создание веб-приложений и других консольных приложений.Создание функциональностей считывающих данные с любых файлов и вносящие в них изменения, реализовывала функциональности загрузки и обработки справочника, различных вариантов его сортировки. Занималась созданием CRUD приложений , а так же Spring Boot веб приложений , где реализовывала регистрацию, логин и другие функции для взаимодействия с клиентом .
